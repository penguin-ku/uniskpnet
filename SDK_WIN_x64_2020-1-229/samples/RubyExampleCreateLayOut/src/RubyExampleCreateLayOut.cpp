...
extern "C"
void Init_RubyExampleCreateLayOut() {
  VALUE mRubyExampleCreateLayOut = rb_define_module("RubyExampleCreateLayOut");
  rb_define_module_function(mRubyExampleCreateLayOut, "create_layout_doc",
                            VALUEFUNC(create_layout_doc), 1);
  rb_define_module_function(mRubyExampleCreateLayOut, "save_layout_doc",
                            VALUEFUNC(save_layout_doc), 0);
  rb_define_module_function(mRubyExampleCreateLayOut, "add_linear_dimension",
                            VALUEFUNC(add_linear_dimension), 5);
  rb_define_module_function(mRubyExampleCreateLayOut, "add_label",
