...
int main(int argc, const char * argv[]) {
  ...
  if (output_file.empty()) {
    cout << "An output file must be specified using the -o argument." << endl;
    return -1;
  }
  ...
  if (output_extension == "pdf") {
    ...
    if (result != SU_ERROR_NONE) {
      ...
      cout << "Document saved to pdf." << endl;
    }
    ...
    if (result != SU_ERROR_NONE) {
      ...
      cout << "Document saved to png." << endl;
    }
  } else if (output_extension == "jpg" || output_extension == "jpeg") {
    ...
    if (result != SU_ERROR_NONE) {
      ...
      cout << "Document saved to jpg." << endl;
    }
  }
